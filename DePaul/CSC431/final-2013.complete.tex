...
\begin{itemize}
\item {\bf True} or {\bf False}: They are equivalent up to numerical issues
\item {\bf True} or {\bf False}: They both diverge when $x=1$
\item {\bf True} or {\bf False}: $f_2$ is better than $f_1$ around $x=-1$
\item {\bf True} or {\bf False}: $f_1$ is better than $f_2$ around $x=1$
\end{itemize}
...
\begin{itemize}
\item {\bf True} or {\bf False}: $P(f)$ finds $x$ which solves $f(x)=0$ using Newton method.
\item {\bf True} or {\bf False}: $Q(f)$ finds $x$ which solves $f'(x)=0$ using Newton method.
\item {\bf True} or {\bf False}: $P(f)$ always converges and converges to the correct result.
\item {\bf True} or {\bf False}: Each call to $P$ calls the function $f$, $2\times\mathrm{ns}$ times.
\end{itemize}
